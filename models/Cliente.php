...
class Cliente extends Conexion
{
    ...
    public function verificarExistenciaDb(){
        $query = "SELECT * FROM Clientes2 WHERE identificacion=:identificacion";
        try {
            self::getConexion();
            $resultado = self::$cnx->prepare($query);      
    ...
    public function guardarEnDb(){
        $query = "INSERT INTO `Clientes2`(`identificacion`, `nombre`, `apellidoPaterno`, `apellidoMaterno`, `nacimientoCliente`, `direccion`, `telefonoCelular`) VALUES (:identificacion, :nombre, :apellidoPaterno, :apellidoMaterno, :nacimientoCliente, :direccion, :telefonoCelular)";
        try {
            self::getConexion();
            $identificacion = $this->getIdentificacion();
    ...
    public function llenarCampos($id){
        $query = "SELECT * FROM Clientes2 WHERE idCliente = :id";
        try {
            self::getConexion();
            $resultado = self::$cnx->prepare($query);
