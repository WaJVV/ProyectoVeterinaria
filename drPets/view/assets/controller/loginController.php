...
if(isset($_POST['usuario']) && isset($_POST['contrasena'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        header("Location: ..\controller\rolAdmiController.php?nombre=".urlencode($nombre)."&apellidos=".urlencode($apellidos));
        exit();
    } else {
        // Credenciales incorrectas, redirigir a la página de login con un mensaje de error
        header("Location: ../model/login.php?error=incorrecto");
        exit();
    }
